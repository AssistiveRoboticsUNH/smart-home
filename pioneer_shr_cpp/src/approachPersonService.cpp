...
class ActionApproachPerson : public rclcpp::Node {
public:
    ActionApproachPerson(const rclcpp::NodeOptions &options = rclcpp::NodeOptions()) : Node(
            "approach_person_action_server", options) {
