...
(:domain shr_domain)
(:objects
    living_room home outside kitchen - Landmark
...
(:init
    ...
    (oneof (person_at t2 nathan living_room) (person_at t2 nathan kitchen) )
    (oneof (person_at t3 nathan living_room) (person_at t3 nathan kitchen) )
    (oneof (person_at t4 nathan living_room) (person_at t4 nathan kitchen) )
    (oneof (person_at t5 nathan living_room) (person_at t5 nathan kitchen) )
