(define (problem medicine_reminder)
    ...
    (:objects
        ...
        nathan - Person
        t1 t2 t3 t4 t5 - Time
        guide_1_msg guide_2_msg automated_msg recorded_msg extra_msg call_caregiver_guide_msg call_caregiver_msg - Msg
        automated_reminder recorded_reminder extra_reminder guide_reminder_1 guide_reminder_2 - ReminderAction
    ...
    (:init
        ...
        (reminder_blocks_reminder automated_reminder extra_reminder)
        (reminder_blocks_reminder extra_reminder recorded_reminder)
        ...
        (valid_reminder_message extra_reminder extra_msg)
        ...
        (reminder_person_location_constraint extra_reminder nathan dest_loc)
        (reminder_person_not_taking_medicine_constraint extra_reminder nathan)
