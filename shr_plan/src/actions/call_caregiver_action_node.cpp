...
class CallCaregiver : public plansys2::ActionExecutorClient {
public:
    CallCaregiver()
            : plansys2::ActionExecutorClient("alertcaregiver", 500ms) {
...
int main(int argc, char **argv) {
    ...
    auto node = std::make_shared<CallCaregiver>();

    node->set_parameter(rclcpp::Parameter("action_name", "alertcaregiver"));
