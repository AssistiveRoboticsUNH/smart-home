...
namespace shr_utils {
    ...
    using NavigationFeedback =
            const std::shared_ptr<const shr_msgs::action::NavigateToPose::Feedback>;
...
//    rclcpp_action::ClientGoalHandle<nav2_msgs::action::NavigateToPose>::SharedPtr
    ...
    void send_nav_request(tf2_ros::Buffer &tf_buffer, const std::string &goal_tf, const rclcpp::Time &cur_time,
                          ...
                          std::optional<const std::function<void(
                                  std::shared_ptr<rclcpp_action::ClientGoalHandle<shr_msgs::action::NavigateToPose>>)>> goal_response_callback = std::nullopt,
                          std::optional<std::function<void(NavigationGoalHandle::SharedPtr,
                                                           NavigationFeedback)>> feedback_callback = std::nullopt,
                          std::optional<std::function<void(
                                  const rclcpp_action::ClientGoalHandle<shr_msgs::action::NavigateToPose>::WrappedResult &)>> result_callback = std::nullopt);
