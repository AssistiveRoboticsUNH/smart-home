...
//    std::string mesh_file = "/home/olagh/smart-home/src/smart-home/external/particle_filter_mesh/config/labxf.obj";
    std::string mesh_file = "/home/olagh/smart-home/src/smart-home/shr_utils/test/data/mesh_test/sajay_room_areas.obj";
...
//    } else { std::cout << " wrong hit " << std::endl; }
    ...
    //door
    Eigen::Vector3d dining_point2 = {-3.45, -3.7, -0.5};
    ...
    // livingtoom
    Eigen::Vector3d dining_point3 = {-0.389, -4.9, -0.5};
    ...
    // kitchen door
    Eigen::Vector3d dining_point4 = {1.07, -0.85, -0.5};
    ...
    // bathroom door
    Eigen::Vector3d dining_point5 = {1.46, 3.89 , -0.5};
