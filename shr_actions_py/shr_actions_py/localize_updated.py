...
###################### ADDDD STop before reading that is triggered by localize
...
class LocalizationActionServer(Node):
    ...
    def __init__(self):
        ...
        self.subscription_pose = self.create_subscription(PoseWithCovarianceStamped, '/amcl_pose',
                                                     self.amcl_pose_callback, 10, callback_group=ReentrantCallbackGroup())
    ...
    def amcl_pose_callback(self, msg):
        print("AMCL POSE")
        if msg:
            print("AMCL POSE MSG Available")
            self.robot_amcl_pose = msg
