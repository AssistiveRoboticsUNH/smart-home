...
from convros_bot.question_response_test import QuestionResponseActionServer  # ✅ Import the updated class
...
def main():
    ...
    question_response_action_server = QuestionResponseActionServer(zmq_socket)  # ✅ Added Question Response Server
